...
import image_about from "../../public/Assets/about.jpg";
import Image from 'next/image';
import women_form from '../../public/Assets/women_form.jpg'
const About = () => {
  return (
    <>
          ...
          <div className="mt-5 sm:mt-10 lg:mt-0">
            <div className="space-y-6 sm:space-y-8">
              <div className="space-y-2 md:space-y-4">
                <h2 className="font-bold text-3xl lg:text-4xl text-blue-600">
                  Sobre Nosotros
                </h2>
                <p className="text-gray-500">
                En Valhalla, somos mucho más que una tienda; somos un reino de estilo y sofisticación. Nuestro viaje comenzó como una visión humilde para ofrecer una experiencia de compra única que trasciende lo ordinario.
                </p>
              </div>
              ...
              <ul role="list" className="space-y-2 sm:space-y-4">
                <li className="flex space-x-3">
                  ...
                  <span className="text-sm sm:text-base text-gray-500">
                    <span className="font-bold">Elegancia en Cada Ropa</span> 
                  </span>
                </li>
                ...
                <li className="flex space-x-3">
                  ...
                  <span className="text-sm sm:text-base text-gray-500">
                  Socios en la Digitalización <span className="font-bold"></span>
                  </span>
                </li>
    ...
    <div className="container px-6 py-10 mx-auto">
        <div className="lg:flex lg:items-center lg:-mx-10">
            <div className="lg:w-1/2 lg:mx-10">
                <h1 className="text-2xl font-semibold text-gray-800 capitalize dark:text-white lg:text-3xl">Formulario</h1>
                ...
                <form className="mt-12">
                    <div className="-mx-2 md:items-center md:flex">
                        ...
                        <div className="flex-1 px-2 mt-4 md:mt-0">
                            ...
                            <input type="email" placeholder="correo@example.com" className="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                        </div>
                    </div>
            ...
            <div className="mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10">
                ...
                <Image className='hidden object-cover mx-auto rounded-full lg:block shrink-0 w-96 h-96' src={women_form}
                alt='image_women' ></Image>
                <div className="mt-6 space-y-8 md:mt-8">
                    ...
                    <p className="flex items-start -mx-2">
                        ...
                        <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">(+57) 0800-666-381</span>
                    </p>
                    ...
                    <p className="flex items-start -mx-2">
                        ...
                        <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">Estafinia@example.com</span>
                    </p>
                </div>
